...
//    var tableData = TimeEntry.groupEntriesByStartDate(TogglService.getAllEntries())
    var tableData = TimeEntry.groupEntriesByStartDate(TimeEntry.fetchAllTimeEntries())
...
//        self.tableData = TimeEntry.groupEntriesByStartDate(TogglService.getAllEntries())
        self.tableData = TimeEntry.groupEntriesByStartDate(TimeEntry.fetchAllTimeEntries())
